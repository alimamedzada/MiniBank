...
public class CustomerServiceImpl implements CustomerServiceInter {
    public Customer createCustomer() {
        ...
        return Customer.createNewCustomer(InputUtil.requireName(), InputUtil.requireSurname(), InputUtil.requireAge(), InputUtil.requireAzeID(), InputUtil.requireUsername(), InputUtil.requirePassword());
    }
}
